        ...
        <div class="container">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    ?>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-<?php echo $vl->id ?>" type="button" role="tab" aria-controls="tab-one" aria-selected="true"><?php echo $vl->ten ?></button>
                            </li>
                        <?php } else { ?>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-<?php echo $vl->id ?>" type="button" role="tab" aria-controls="tab-one" aria-selected="true"><?php echo $vl->ten ?></button>
                            </li>
                    <?php
                        }
                        $count++;
            ...
            <div class="tab-content wow fadeIn animated" id="myTabContent">
                ...
                foreach ($danh_muc as $key => $vl1) {
                    if ($count == 1) { ?>
                        <div class="tab-pane fade show active" id="tab-<?php echo $vl1->id ?>" role="tabpanel" aria-labelledby="tab-one">
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom" style="position: relative; width: 100%; height: 0;padding-bottom: 120%;overflow: hidden;">
                                    <a href="index.php?controller=sanPham_view&id=<?php echo $vl->id_san_pham ?>&loai=<?php echo $vl->id_loai_san_pham ?>&botruyen=<?php echo $vl->id_bo_truyen ?>"">
                                    <img class=" default-img" src="assets/imgs/shop/<?php echo $vl->hinh_anh ?>" width="100%" alt="" style=" position: absolute;top: 0;left: 0;width: 100%;height: 100%; object-fit: cover; ">
                                        <img class=" default-img" src="assets/imgs/shop/<?php echo $vl->hinh_anh ?>" width="100%" alt="" style=" position: absolute;top: 0;left: 0;width: 100%;height: 100%; object-fit: cover; ">
                                    </a>
                                </div>
                                <div class="product-action-1">
