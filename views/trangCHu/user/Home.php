    ...
    <section class="product-tabs section-padding position-relative wow fadeIn animated " ">
        ...
        <div class="container">
            ...
            <div class="tab-header">
                ...
                <a href="index.php?controller=sanPham_view_more" class="view-more d-none d-md-flex">View More<i
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom"
                                ...
                                <a
                                    href="index.php?controller=sanPham_view&id=<?php echo $vl->id_san_pham ?>&loai=<?php echo $vl->id_loai_san_pham ?>&botruyen=<?php echo $vl->id_bo_truyen ?>">
                                    <img class="default-img" src="assets/imgs/shop/<?php echo $vl->hinh_anh ?>"
                                        alt="loi" width="100%" alt="" style="margin:  auto;min-height:  300px;">
                                    <img class="hover-img" src="assets/imgs/shop/<?php echo $vl->hinh_anh ?>" alt="loi"
                                        width="100%" alt="" style="margin: auto;min-height: 300px;">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn hover-up"
