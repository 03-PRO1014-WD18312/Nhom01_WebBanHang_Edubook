        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="<?php if ($soLuong == 0 || $soLuong == "") {
                                        echo 'index.php?controller=check&&nd=thanhToan';
                                    } else {
                                        echo "index.php?controller=muaHang";
                                    } ?>" method="post">
                        ...
                        <input class="form-control" id="txt_billing_email" name="txt_billing_email" type="hidden" value="xonv@vnpay.vn" />
                        ...
                        <input class="form-control" id="txt_bill_city" name="txt_bill_city" type="hidden" value="Hà Nội" />
                                    ...
                                    <?php foreach ($thongTinSp as $sp) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="product-qty">x<?php if ($soLuong == 0 && $soLuong == "") {
                                                                                echo $soLuong;
                                                                            } else {
                                                                                echo $soLuong;
                                                                            } ?></span>
